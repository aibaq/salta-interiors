...
var image = document.querySelectorAll('.list-portf img');
...
var main = document.querySelectorAll('.about img');
new simpleParallax(main,{
    orientation:"up left",
    // scale:1,
    overflow:true,
    delay: 0.6,
...
var portf = document.querySelectorAll('.main-images img');
new simpleParallax(portf, {
    overflow: true,
    delay: .6,
    transition: 'cubic-bezier(0,0,0,1)'
});
